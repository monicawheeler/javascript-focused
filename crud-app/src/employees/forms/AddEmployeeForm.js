...
const AddEmployeeForm = props => {
	...
	return (
		...
		>
            ...
            <label>Country</label>
            <select name="country" value={employee.country} onChange={handleInputChange}>
            ...
            <label>Salary</label>
            <input type="text" name="salary" value={employee.salary} onChange={handleInputChange} />
			<button>Add new employee</button>
            {/* TODO: update this to reach router */}
            {/* <Link to="/">Cancel</Link> */}
		</form>
	)
}
